...
docker run -d --name hugoshare -p 443:8080 -v /home/ec2-user/certs:/home/ec2-user/certs --env-file /home/.env 329599616303.dkr.ecr.us-east-2.amazonaws.com/hugoshare:latest
if [ $? -ne 0 ]; then
